...
<body>
	...
	<main>
		<div class=container>
			<br><br>
			<div class="row animated fadeInRight" style="height: 20vw;">
				<div class="col-lg-8">
				...
				<div class="col-lg-4" style="background-color: rgba(0, 0, 0, 0.6); padding: 10px; color: white">
			...
			<h1 class="animated fadeInRight">Stay Close</h1><br>
